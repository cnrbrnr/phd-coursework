...
\begin{document}\thispagestyle{empty}
    ...
    \begin{theorem}[Fourier Decomposition of WS Processes {\cite[theorem 10]{Fan_1946}}]\label{thm3}
...
\end{document}
    ...
    % \begin{align*}
    %     \left\|C_N\right\|_{op}=\|\frac{1}{N}\sum_{n=0}^{N-1}U^n\|_{op}\leq\frac{1}{N}\sum_{n=0}^{N-1}\|U\|_{op}^n\leq 1since
    % \end{align*}
